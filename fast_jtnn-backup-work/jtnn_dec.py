...
class JTNNDecoder(nn.Module):
    ...
    def __init__(self, vocab, hidden_size, latent_size, embedding):
        ...
        self.hidden_size = int(hidden_size)  # Ensure hidden_size is an integer
        ...
        self.W = nn.Linear(self.hidden_size + int(latent_size), self.hidden_size)

        # Stop Prediction Weights
        self.U = nn.Linear(self.hidden_size + int(latent_size), self.hidden_size)
